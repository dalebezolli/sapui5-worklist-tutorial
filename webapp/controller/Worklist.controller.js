sap.ui.define([
	...
	return BaseController.extend("mycompany.myapp.MyWorklistApp.controller.Worklist", {
		...
		_showErrorMessage: function(message) {
			MessageBox.error(message, { styleClass: this.getOwnerComponent().getContentDensityClass() });
		},

		onQuickFilter: function(oEvent) {
			this._oTable.getBinding("items").filter(this._mFilters[oEvent.getParameter("selectedKey")]);
		},
